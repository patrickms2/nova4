...
class ViewMonthlyAttendance extends Page implements HasForms
{
    ...
    protected string $view = 'filament.resources.attendance-resource.widgets.work-hour-this-week';
    ...
    public function mount(): void
    {
        ...
        $this->isEmployeeUser = $currentUser->user_type === UsuarioTipo::EMPLOYEE;
