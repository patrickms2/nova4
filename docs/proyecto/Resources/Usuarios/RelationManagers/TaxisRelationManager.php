...
use App\Filament\App\Resources\Taxis\TaxiResource;
use App\Filament\App\Resources\Usuarios\RelationManagers\Forms;
...
class TaxisRelationManager extends RelationManager
{
    ...
    public function form0(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Select::make('recordId')
                    ->label('Taxi')
                    ->options(TaxistaTaxi::pluck('matricula', 'id'))
                    ->required()
                    ->searchable()
                    ->preload(),
