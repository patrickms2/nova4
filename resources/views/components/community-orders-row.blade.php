...
@endphp
<button type="button"  wire:click="openDetail('order', {{ $order->id }})"  {{ $attributes->class('community-portal-row group w-full border-l-2 border-l-blue-500 p-3 text-left sm:p-4') }}>
