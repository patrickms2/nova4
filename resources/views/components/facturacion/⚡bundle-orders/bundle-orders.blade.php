            ...
            <tbody class="divide-y divide-slate-200">
                @forelse ($bundles as $bundle)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <a href="{{ route('public.bundle') }}?ref={{ $bundle->bundle_reference }}" target="_blank" class="text-slate-400 hover:text-slate-600">Ver</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="8" class="px-4 py-8 text-center text-sm text-slate-500">No hay pedidos cruzados registrados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
