    ...
    >
        <div class="w-full max-w-md p-6 transition-all transform scale-100 bg-white border shadow-2xl rounded-2xl border-slate-100">
            ...
            <div class="mt-5 pt-3 border-t border-slate-100 flex justify-end gap-2.5">
                ...
                <button wire:click="saveNuevoConcepto" type="button" class="px-4 py-2 text-xs font-bold text-white transition-all bg-indigo-600 shadow-sm cursor-pointer rounded-xl hover:bg-indigo-700 shadow-indigo-600/10 active:scale-95">
                    Guardar concepto
                </button>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        @if(! empty($veriFactuDetail['qr_url']))
                            <div class="col-span-2">
                                ...
                                <a href="{{ $veriFactuDetail['qr_url'] }}" target="_blank" class="text-indigo-600 break-all hover:underline">{{ $veriFactuDetail['qr_url'] }}</a>
                            </div>
                        @endif
                    </div>
    ...
    >
        <div class="w-full max-w-md p-6 transition-all transform scale-100 bg-white border shadow-2xl rounded-2xl border-slate-100">
            ...
            <div class="mt-5 pt-3 border-t border-slate-100 flex justify-end gap-2.5">
                ...
                @else
                    <button wire:click="iniciarGenerarRemesa" type="button" class="px-4 py-2 text-xs font-bold text-white transition-all bg-indigo-600 shadow-sm cursor-pointer rounded-xl hover:bg-indigo-700 shadow-indigo-600/10 active:scale-95">
                        Generar
                    </button>
                @endif
            </div>
    ...
    >
        <div class="w-full max-w-md p-6 transition-all transform scale-100 bg-white border shadow-2xl rounded-2xl border-slate-100">
            ...
            <div class="mt-5 pt-3 border-t border-slate-100 flex justify-end gap-2.5">
                ...
                <button wire:click="importPdf" type="button" class="px-4 py-2 text-xs font-bold text-white transition-all bg-indigo-600 shadow-sm cursor-pointer rounded-xl hover:bg-indigo-700 shadow-indigo-600/10 active:scale-95">
                    Importar factura
                </button>
            </div>
        </div>
