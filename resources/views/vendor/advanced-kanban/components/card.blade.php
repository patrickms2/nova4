       ...
       <div>
            <div>
                @php
                    ...
                    //dd($column);
                    $color=TaskStatus::getColorBySlug($record->status);
                    $icon = TaskStatus::getIconBySlug($record->status) ?? 'heroicon-s-document-text';
                ...
                <x-filament::badge
                    ...
                    :icon="$icon"
                >
                    {{ TaskStatus::getLabelBySlug($record->status) }}
           </x-filament::badge>
       </div>
