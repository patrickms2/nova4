                            ...
                            @if(!$this->isReadOnly())
                                ...
                                >
                                    <button
                                        ...
                                        title="Add folder"
                                    >
                                        @svg('heroicon-o-folder-plus', 'w-3 h-3')
                                    </button>
                                </div>
                            @endif
                        </div>
            ...
            <main class="flex-1 overflow-y-auto bg-white dark:bg-gray-900 p-4">
                @if($this->items->isEmpty())
                    ...
                    <div class="flex flex-col items-center justify-center h-full">
                        @svg('heroicon-o-folder-open', 'w-12 h-12 text-gray-400 dark:text-gray-500 mb-3')
                        ...
                        <div class="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 mb-3">
                            <div class="flex items-center gap-2">
                                ...
                                @if($this->allSelected())
                                    ...
                                    >
                                        <x-filament::icon icon="heroicon-o-x-circle" class="w-3.5 h-3.5" />
        ...
        <div class="space-y-4">
            ...
            >
                ...
                <div class="space-y-2" wire:loading.remove wire:target="uploadedFiles">
                    @svg('heroicon-o-cloud-arrow-up', 'w-10 h-10 mx-auto text-gray-400 dark:text-gray-500')
