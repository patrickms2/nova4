<div>
    @php
        ...
        $drilldownSubGroups = method_exists(filament('drilldown-sidebar'), 'getSubGroups')
            ...
            : [
                'Tourist' => ['Tours', 'Taxi', 'Activities', 'Restaurants', 'Hotels', 'Locations'],
                'Bookings' => ['Bookings'],
                'Nova' => ['Admin'],
        ...
        $drilldownSubGroupItemLabels = [
            'Tourist' => [
                'Tours' => ['Tours', 'Tour Bookings', 'Tour Schedules', 'Tour Images', 'Tour Categories','Tour Translations'],
            ...
            'Bookings' => [
                'Bookings' => ['Bookings', 'External Bookings', 'Package Bookings', 'Public requests', 'Tour Bookings', 'Taxi Bookings'],
            ],
            'Nova' => [
                'Cliente' => ['Clientes Nova'],
