    ...
    <div class="space-y-4">
        ...
        <div class="grid items-end gap-4 lg:grid-cols-[1fr_420px]">
            <div class="rounded-lg border border-gray-200 bg-white p-4">
                <div class="text-sm text-gray-500">Reservas por servicio</div>
                ...
                <div class="grid" style="display: grid; grid-template-columns: 260px repeat({{ $days->count() }}, minmax(96px, 1fr));">
                    ...
                    @forelse ($rows as $row)
                        <div class="sticky left-0 z-10 border-b border-r border-gray-100 bg-white px-3 py-2">
                            ...
                            <div class="truncate text-xs text-gray-500">{{ $row['key'] }}
<a href="{{ route('filament.admin.resources.bookings.index', ['filters[booking_type][value]' => $row['key']]) }}" class="text-blue-600 hover:text-blue-800">Ver reservas</a>
                        ...
                        @foreach ($row['cells'] as $cell)
                            ...
                            <div class="border-b border-gray-100 px-2 py-2">
                                <div @class([
                                    ...
                                    <div class="text-xs font-semibold text-gray-950">
                                        @if ($count > 0)
                                            {{ $count }}
                                        @else
