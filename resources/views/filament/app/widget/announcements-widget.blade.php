        ...
        @else
            ...
            >
                @foreach ($announcements as $announcement)
                    @php
                        $body = new \Illuminate\Support\HtmlString($announcement->body);
                        ...
                        $bgColorClass = match ($announcement->type) {
                            AnnouncementType::Danger => 'bg-danger-100 dark:bg-danger-500',
                            AnnouncementType::Warning => 'bg-warning-100 dark:bg-warning-500',
                            AnnouncementType::Info => 'bg-info-100 dark:bg-info-500',
                            AnnouncementType::Success => 'bg-success-100 dark:bg-success-500',
                        };
                    ...
                    <li
                        ...
                        class="overflow-hidden rounded-xl {{ $bgColorClass }} shadow-sm ring-1 ring-gray-950/5 dark:bg-white/5 dark:ring-white/10"
                    >
                        <div
