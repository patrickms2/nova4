...
var VoodflowNode_Acciones = (() => {
  ...
  // ../../../storage/voodflow-nodes/Acciones/components/Acciones.jsx
  var Acciones_exports = {};
  __export(Acciones_exports, {
  ...
  var Acciones = ({ id, data, selected }) => {
    ...
    const {
      ...
      shouldShowLogo,
      hasConfiguration
    } = useStandardNodeBehavior(id, { ...data, defaultLabel: "Acciones" }, getEdges, setNodes, false);
    const [showDeleteModal, setShowDeleteModal] = (0, import_react18.useState)(false);
    const [label, setLabel] = (0, import_react18.useState)(data.label || "Acciones");
  ...
  var Acciones_default = Acciones;
  return __toCommonJS(Acciones_exports);
})();
