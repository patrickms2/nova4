...
var VoodflowNode_Recurso = (() => {
  ...
  // ../../../storage/voodflow-nodes/Recurso/components/Recurso.jsx
  var Recurso_exports = {};
  __export(Recurso_exports, {
    default: () => Recurso_default
  });
  ...
  var Recurso = ({ id, data, selected }) => {
    ...
    const [label, setLabel] = (0, import_react18.useState)(data.label || "Recurso");
  ...
  var Recurso_default = Recurso;
  return __toCommonJS(Recurso_exports);
})();
