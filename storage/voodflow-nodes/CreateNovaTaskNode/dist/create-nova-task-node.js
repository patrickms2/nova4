...
var VoodflowNode_CreateNovaTaskNode = (() => {
  ...
  // ../../../storage/voodflow-nodes/CreateNovaTaskNode/components/CreateNovaTaskNode.jsx
  var CreateNovaTaskNode_exports = {};
  __export(CreateNovaTaskNode_exports, {
    default: () => CreateNovaTaskNode_default
  });
  ...
  var SelectInput = ({
    ...
    const baseClass = color === "slate" ? SELECT_STYLES.BASE : SELECT_STYLES.withColor(color);
    return /* @__PURE__ */ import_react10.default.createElement(
      "select",
      {
        value,
      ...
      placeholder && /* @__PURE__ */ import_react10.default.createElement("option", { value: "" }, placeholder),
      options.map((opt) => /* @__PURE__ */ import_react10.default.createElement("option", { key: opt.value, value: opt.value }, opt.label))
    );
  };
  ...
  // ../../../storage/voodflow-nodes/CreateNovaTaskNode/components/CreateNovaTaskNode.jsx
  var CreateNovaTaskNode = ({ id, data, selected }) => {
    ...
    const [label, setLabel] = (0, import_react18.useState)(data.label || "CreateNovaTaskNode");
    const [description, setDescription] = (0, import_react18.useState)(data.description || "");
    const [title, setTitle] = (0, import_react18.useState)(data.title || "");
    const [descriptionField, setDescriptionField] = (0, import_react18.useState)(data.description_field || "");
    const [dueDate, setDueDate] = (0, import_react18.useState)(data.due_date || "");
    const [estimatedHours, setEstimatedHours] = (0, import_react18.useState)(data.estimated_hours || "1");
    const [priority, setPriority] = (0, import_react18.useState)(data.priority || "medium");
    (0, import_react18.useEffect)(() => {
      if (configReadOnly) return;
      const hasChanged = label !== data.label || description !== data.description || title !== data.title || descriptionField !== data.description_field || dueDate !== data.due_date || estimatedHours !== data.estimated_hours || priority !== data.priority;
    ...
    const getCollapsedSummary = () => {
      ...
      return `${title} \xB7 ${dueDate || "sin fecha"} \xB7 ${priority}`;
    };
    return /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, canShowDeleteButton && /* @__PURE__ */ import_react18.default.createElement(
      ...
      ), /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-4 pb-4 border-t border-slate-100 dark:border-slate-800 pt-4 space-y-4" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react18.default.createElement(FieldLabel, null, "Title"), /* @__PURE__ */ import_react18.default.createElement(
        TextInput,
        {
          value: title,
      ...
      )), /* @__PURE__ */ import_react18.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react18.default.createElement(FieldLabel, null, "Description"), /* @__PURE__ */ import_react18.default.createElement(
        TextInput,
        {
      ...
      )), /* @__PURE__ */ import_react18.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react18.default.createElement(FieldLabel, null, "Due Date"), /* @__PURE__ */ import_react18.default.createElement(
        TextInput,
        {
          value: dueDate,
      ...
      )), /* @__PURE__ */ import_react18.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react18.default.createElement(FieldLabel, null, "Estimated Hours"), /* @__PURE__ */ import_react18.default.createElement(
        TextInput,
        {
      ...
      )), /* @__PURE__ */ import_react18.default.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ import_react18.default.createElement(FieldLabel, null, "Priority"), /* @__PURE__ */ import_react18.default.createElement(
        SelectInput,
        {
          value: priority,
  ...
  var CreateNovaTaskNode_default = CreateNovaTaskNode;
  return __toCommonJS(CreateNovaTaskNode_exports);
})();
//# sourceMappingURL=create-nova-task-node.js.map
