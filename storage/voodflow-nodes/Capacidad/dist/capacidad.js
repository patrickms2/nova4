...
var VoodflowNode_Capacidad = (() => {
  ...
  // ../../../storage/voodflow-nodes/Capacidad/components/Capacidad.jsx
  var Capacidad_exports = {};
  __export(Capacidad_exports, {
    default: () => Capacidad_default
  });
  var import_react20 = __toESM(__require("react"), 1);
  var import_react21 = __require("@xyflow/react");
  ...
  // ../../../storage/voodflow-nodes/Capacidad/components/CapabilityAddMenu.jsx
  var import_react18 = __toESM(__require("react"), 1);
  var import_react19 = __require("@xyflow/react");
  var NOVA_ADDRESS_PREFIX = "NOVA Address: ";
  var CAPABILITY_PREFIX = "studio.graph.node.capability.";
  function capabilityIdFromDescription(description) {
    if (typeof description !== "string") return null;
    const address = description.startsWith(NOVA_ADDRESS_PREFIX) ? description.slice(NOVA_ADDRESS_PREFIX.length).trim() : description.trim();
  ...
  function addressFromDescription(description) {
    if (typeof description !== "string") return null;
    return description.startsWith(NOVA_ADDRESS_PREFIX) ? description.slice(NOVA_ADDRESS_PREFIX.length).trim() : null;
  }
  ...
  var CapabilityAddMenu = ({ capabilityNodeId, capabilityLabel, capabilityId, color }) => {
    const [isOpen, setIsOpen] = (0, import_react18.useState)(false);
    const [loading, setLoading] = (0, import_react18.useState)(false);
    const [error, setError] = (0, import_react18.useState)(null);
    const [options, setOptions] = (0, import_react18.useState)(null);
    const containerRef = (0, import_react18.useRef)(null);
    const { getNode, getNodes, getEdges } = (0, import_react19.useReactFlow)();
    ...
    const alreadyAddedAddresses = import_react18.default.useMemo(() => {
      if (!isOpen) return /* @__PURE__ */ new Set();
    ...
    const addItem = (0, import_react18.useCallback)((kind, item) => {
    ...
    return /* @__PURE__ */ import_react18.default.createElement("div", { ref: containerRef, className: "relative nodrag" }, /* @__PURE__ */ import_react18.default.createElement(
      "button",
      {
        type: "button",
        onClick: () => setIsOpen((v) => !v),
        title: `Add to ${capabilityLabel}`,
        className: `flex items-center justify-center w-6 h-6 rounded-full border-2 border-white dark:border-slate-900 text-white shadow-md transition-colors ${BUTTON_COLOR_CLASSES[color] || BUTTON_COLOR_CLASSES.slate}`
      },
      /* @__PURE__ */ import_react18.default.createElement("svg", { className: "w-3.5 h-3.5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, /* @__PURE__ */ import_react18.default.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2.5", d: "M12 4v16m8-8H4" }))
    ), isOpen && /* @__PURE__ */ import_react18.default.createElement("div", { className: "nodrag absolute right-0 top-full mt-2 w-64 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xl z-50 overflow-hidden" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-3 py-2 border-b border-slate-100 dark:border-slate-800" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "text-[10px] font-black uppercase tracking-widest text-slate-400" }, "Add to"), /* @__PURE__ */ import_react18.default.createElement("div", { className: "text-sm font-bold text-slate-800 dark:text-slate-100 truncate" }, capabilityLabel)), loading && /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-3 py-4 text-xs text-slate-400 italic" }, "Loading\u2026"), error && !loading && /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-3 py-4 text-xs text-red-500" }, error), !loading && !error && options && /* @__PURE__ */ import_react18.default.createElement("div", { className: "max-h-80 overflow-y-auto" }, /* @__PURE__ */ import_react18.default.createElement(
      MenuSection,
      {
        title: "Acciones",
  ...
  function MenuSection({ title, items, addedAddresses, onSelect, emptyLabel }) {
    return /* @__PURE__ */ import_react18.default.createElement("div", { className: "py-1.5" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-3 py-1 text-[10px] font-black uppercase tracking-widest text-slate-400" }, title), items.length === 0 && /* @__PURE__ */ import_react18.default.createElement("div", { className: "px-3 pb-2 text-xs text-slate-400 italic" }, emptyLabel), items.map((item) => {
      ...
      return /* @__PURE__ */ import_react18.default.createElement(
        "button",
        {
          ...
          className: `w-full flex items-center justify-between px-3 py-1.5 text-xs text-left transition-colors ${added ? "text-slate-400 cursor-default" : "text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer"}`
        },
        /* @__PURE__ */ import_react18.default.createElement("span", null, item.label),
        /* @__PURE__ */ import_react18.default.createElement("span", null, added ? "\u2713" : "+")
      );
    }));
  }
  var CapabilityAddMenu_default = CapabilityAddMenu;

  // ../../../storage/voodflow-nodes/Capacidad/components/Capacidad.jsx
  var Capacidad = ({ id, data, selected }) => {
    const nodeColor = data.color || "emerald";
    const { ConfirmModal, SimpleAddButton, VoodflowLogo } = window.VoodflowCommon || {};
    const { setNodes, getEdges } = (0, import_react21.useReactFlow)();
    ...
    const {
      ...
      shouldShowLogo,
      hasConfiguration
    } = useStandardNodeBehavior(id, { ...data, defaultLabel: "Capacidad" }, getEdges, setNodes, false);
    const novaCapabilityId = capabilityIdFromDescription(data.description);
    const [showDeleteModal, setShowDeleteModal] = (0, import_react20.useState)(false);
    const [label, setLabel] = (0, import_react20.useState)(data.label || "Capacidad");
    const [description, setDescription] = (0, import_react20.useState)(data.description || "");
    ...
    return /* @__PURE__ */ import_react20.default.createElement(import_react20.default.Fragment, null, canShowDeleteButton && /* @__PURE__ */ import_react20.default.createElement(
      ConfirmModal,
      {
        isOpen: showDeleteModal,
        title: "Delete Capacidad",
      ...
      !workflowReadOnly && novaCapabilityId && /* @__PURE__ */ import_react20.default.createElement("div", { className: "absolute -top-2 -right-2 z-20" }, /* @__PURE__ */ import_react20.default.createElement(
        CapabilityAddMenu_default,
        {
          capabilityNodeId: id,
          capabilityLabel: label,
          capabilityId: novaCapabilityId,
          color: nodeColor
        }
      )),
      isExpanded ? /* @__PURE__ */ import_react20.default.createElement("div", { className: "nodrag" }, /* @__PURE__ */ import_react20.default.createElement(NodeConfigReadOnlyNotice, { data }), /* @__PURE__ */ import_react20.default.createElement(NodeNonExecutableNotice, { data }), /* @__PURE__ */ import_react20.default.createElement(
        NodeConfigFields,
        {
          label,
          description,
      ...
      !workflowReadOnly && !isOutputConnected && SimpleAddButton && /* @__PURE__ */ import_react20.default.createElement("div", { className: "absolute right-0 top-1/2 translate-x-1/2 -translate-y-1/2 z-10" }, /* @__PURE__ */ import_react20.default.createElement(
        SimpleAddButton,
        {
  ...
  var Capacidad_default = Capacidad;
  return __toCommonJS(Capacidad_exports);
})();
//# sourceMappingURL=capacidad.js.map
