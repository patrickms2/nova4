...
import CapabilityAddMenu, { capabilityIdFromDescription } from './CapabilityAddMenu';

/**
 * Capacidad React Component
 *
 ...
 */
const Capacidad = ({ id, data, selected }) => {
    ...
    // NOVA capability id (e.g. "reservations"), resolved from the stable
    // "NOVA Address: studio.graph.node.capability.<id>" description, never
    // from the translated label. Only real NOVA capability nodes get the
    // contextual "Add to <Capability>" menu (mission 030).
    const novaCapabilityId = capabilityIdFromDescription(data.description);

    // ✅ Form State
    const [showDeleteModal, setShowDeleteModal] = useState(false);
    const [label, setLabel] = useState(data.label || 'Capacidad');
    ...
    return (
        <>
            ...
            >
                ...
                {!workflowReadOnly && novaCapabilityId && (
