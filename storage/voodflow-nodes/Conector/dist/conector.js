...
var VoodflowNode_Conector = (() => {
  ...
  // ../../../storage/voodflow-nodes/Conector/components/Conector.jsx
  var Conector_exports = {};
  __export(Conector_exports, {
    default: () => Conector_default
  });
  ...
  var Conector = ({ id, data, selected }) => {
    ...
    const {
      ...
      shouldShowLogo,
      hasConfiguration
    } = useStandardNodeBehavior(id, { ...data, defaultLabel: "Conector" }, getEdges, setNodes, false);
    const [showDeleteModal, setShowDeleteModal] = (0, import_react18.useState)(false);
    const [label, setLabel] = (0, import_react18.useState)(data.label || "Conector");
    ...
    return /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, canShowDeleteButton && /* @__PURE__ */ import_react18.default.createElement(
      ...
      /* @__PURE__ */ import_react18.default.createElement(
        ...
        {
          color: nodeColor,
          icon: data.icon || "M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z",
          nodeData: data,
  ...
  var Conector_default = Conector;
  return __toCommonJS(Conector_exports);
})();
