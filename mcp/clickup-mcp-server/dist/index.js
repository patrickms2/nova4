...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
        switch (name) {
            ...
            case 'update_task': {
                const { task_id, assignees_add, assignees_remove, tags_add, tags_remove, ...taskData } = args;
