...
#[Description('Lista categorías de tareas con filtros opcionales por texto y estado. Devuelve un resumen en JSON de cada categoría.')]
class ListTaskCategoriesTool extends Tool
{
    public function handle(Request $request): Response
    {
        ...
        return Response::json([
            ...
            'categories' => $categories->map(fn (TaskCategory $category): array => [
                'id' => $category->id,
                'name' => $category->name,
                'slug' => $category->slug,
                ...
                'tasks_count' => $category->tasks_count ?? $category->tasks()->count(),
