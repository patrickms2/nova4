...
#[Description('Crea una nueva categoría de proyecto. Acepta nombre, slug, descripción, color, icono y ordenamiento. Devuelve la categoría creada en JSON.')]
class CreateProjectCategoryTool extends Tool
{
    public function handle(Request $request): Response
    {
        ...
        $category = ProjectCategory::create(array_merge($validated, [
            'created_by' => auth()->id(),
        ]));
