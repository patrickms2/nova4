...
class TaxiBookingVehicleAssigned implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        return [
            ...
            new PrivateChannel('vehicle.'.$this->taxiBooking->vehicle_id),
        ];
    }
    ...
    {
        return 'taxi-booking.vehicle-assigned';
    }
    ...
    public function broadcastWith()
    {
        return [
            ...
            'pickup_location_id' => $this->taxiBooking->pickup_location_id,
            'dropoff_location_id' => $this->taxiBooking->dropoff_location_id,
