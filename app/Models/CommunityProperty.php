...
class CommunityProperty extends Model
{
    ...
    {
        return $this->hasMany(CommunityFee::class, 'property_id');
    }
    ...
    {
        return $this->belongsToMany(Person::class, 'community_property_person')->withPivot(['role', 'metadata'])->withTimestamps();
    }

    /*public function owners(): BelongsToMany
    {
        return $this->belongsToMany(Person::class, 'community_property_person')
            ->withPivot('role')
            ->withTimestamps();
    }*/
