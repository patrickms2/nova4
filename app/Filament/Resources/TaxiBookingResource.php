...
class TaxiBookingResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Taxi';
                ...
                Section::make('Booking Information')
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('driver_id')
                            ->relationship('driver', 'license_number')->searchable()
                            ->preload(),
                        ...
                        Forms\Components\Select::make('dropoff_location_id')
                            ->relationship('dropoffLocation', 'name')->searchable(),
        ...
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('booking.payment_status')
                    ...
                    ->badge()
                    ->toggleable(isToggledHiddenByDefault: false),
                Tables\Columns\TextColumn::make('driver.user.fullname')
                    ->label('Driver'),
                Tables\Columns\TextColumn::make('vehicle.registration_number')
                    ->label('Vehicle'),
            ])
            ->filters([
                Tables\Filters\SelectFilter::make('taxi_service_id')
                    ->relationship('taxiService', 'name')->searchable(),
