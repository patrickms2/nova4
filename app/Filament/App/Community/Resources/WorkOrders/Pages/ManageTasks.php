...
class ManageTasks extends ManageRelatedRecords
{
    ...
    protected static ?string $navigationLabel = 'Tareas en orden';
    ...
    public function table(Table $table): Table
    {
        ...
        TextColumn::make('title')->label('Tarea')->wrap(), TextColumn::make('priority')->label('Prioridad')->badge(), TextColumn::make('status')->label('Estado')->badge(), TextColumn::make('completer.name')->label('Completada por')->placeholder('—'), TextColumn::make('completed_at')->label('Finalizada')->dateTime()->placeholder('—')])
        ...
        ->recordActions([
            ...
            DeleteAction::make(),
            ViewAction::make(),
            Action::make('complete')->label('Completar')->icon('heroicon-o-check')->color('success')->visible(fn (WorkOrderTask $record): bool => $record->status !== 'completed')->requiresConfirmation()->action(function (WorkOrderTask $record): void {
