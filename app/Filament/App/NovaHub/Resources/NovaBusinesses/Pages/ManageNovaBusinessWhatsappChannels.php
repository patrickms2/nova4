...
final class ManageNovaBusinessWhatsappChannels extends ManageRelatedRecords
{
    ...
    public static function getNavigationBadge(): ?string
    {
        ...
        return (string) cache()->remember(
                    ...
                    now()->addMinute(),
                    fn () => $record->whatsappChannels()->count()
                );
    }
