...
return [
    ...
    */
    ...
    'permissions' => [
        'NSCameraUsageDescription' => 'Se usa para adjuntar fotos al parte de trabajo.',
        'NSMicrophoneUsageDescription' => 'Se usa para grabar notas de voz en el parte de trabajo.',
        'NSPhotoLibraryUsageDescription' => 'Se usa para seleccionar fotos para el parte de trabajo.',
    ],
