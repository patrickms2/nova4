...
return [
    ...
    */
    ...
    'component_layout' => 'layouts::front',
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:25600'],          // MIME and domain-specific limits are validated by each component.
    ...
    */
    ...
    'payload' => [
        'max_size' => (int) env('LIVEWIRE_PAYLOAD_MAX_SIZE', 10 * 1024 * 1024),   // Maximum request payload size in bytes
        'max_nesting_depth' => 10,   // Maximum depth of dot-notation property paths
        // Raised from Livewire's default (50): Voodflow's FlowEditor issues one
        // updateNodeConfig/saveFlowData Livewire call per node on every canvas
        // interaction (drag, config edit), routinely exceeding 50 calls in a
        // single batched request on flows with several nodes.
        'max_calls' => 300,          // Maximum method calls per request
