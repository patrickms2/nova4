...
return [
    ...
    'advanced_search' => [
        ...
        'constraints_plural' => [
            ...
            'contains' => 'enthalten',
            'does_not_contain' => 'enthalten nicht',
            'equals' => 'sind gleich',
            'does_not_equal' => 'sind nicht gleich',
            'starts_with' => 'beginnen mit',
            'does_not_start_with' => 'beginnen nicht mit',
            'ends_with' => 'enden mit',
            'does_not_end_with' => 'enden nicht mit',

        ],

        'indicator_more' => '+ :count mehr',
        ...
        'dropdown' => [
            ...
            'no_results' => 'Keine passenden Optionen',
            'constraints_header' => 'Einschränkungen',
            'columns_header' => 'Spalten',
            'database_header' => 'Datenbank',
            'boolean_header' => 'Logisch',

        ],

        'search_reference' => [

            'tooltip' => 'Suchreferenz',
            'heading' => 'Suchreferenz',
            'navigation' => 'Navigation',
            'focus_search' => 'Suche fokussieren',
            'open_dropdown' => 'Dropdown öffnen',
            'navigate_dropdown' => 'Dropdown navigieren',
            'select_tag' => 'Tag auswählen',
            'remove_tag' => 'Tag entfernen',
            'constraints' => 'Einschränkungen',
            'search' => 'Suche',
            'exact_phrase' => 'Exakte Phrase',
            'search_words' => 'Suchbegriffe',
            'columns' => 'Spalten',
            'single' => 'Einzeln',
            'multiple' => 'Mehrere',
            'combined' => 'Kombiniert',
            'column_example_column' => 'Name',
            'column_example_columns' => 'Name,E-Mail',
            'boolean' => 'Logisch',
            'and_operator' => 'UND',
            'or_operator' => 'ODER',
